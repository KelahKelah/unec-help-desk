...
//                            $student_id = urlencode($row['student_id']);
                            ...
                            <tr>
                                ...
                                <form action="updateRequests.php" method="post">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="Update" name="up_btn">
                                </form>
                                <form action="delete.php" method="post">
                                    <input type="hidden" value="<?php echo $request_id?>" name="del">
                                    <input type="submit" class="btn btn-primary" value="Delete" name="del_btn">
